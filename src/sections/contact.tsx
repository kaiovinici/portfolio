  ...
  return (
    <section id="contato" className="scroll-mt-20 border-t border-white/[0.06] py-24 sm:py-32">
      <Container>
        ...
        <h2 className="mt-5 max-w-4xl text-4xl font-semibold tracking-[-0.045em] text-white sm:text-6xl">Vamos construir algo que funcione do código à infraestrutura.</h2>
